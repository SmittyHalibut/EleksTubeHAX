...
Hacking the Hacking the EleksTube IPS Clock
...
Photo of this sketch running is at 
https://github.com/SmittyHalibut/EleksTubeHAX/blob/main/BoingBall/BoingBall_working.jpg

Install TFT_eSPI from the Arduino 1.18.3 Tools menu -> Manage Libraries -> Install
TFT_eSPI.

This sketch is based on Examples -> TFT_eSPI -> Generic -> boing_ball

Add 74HC595 setup
Add display power set-up

On MacOS change 
changed the ~/Documents/Arduino/libraries/TFT_eSPI/User_Setup.h as:
...
Compile, upload and watch the ball bounce.

Hack by Frank Cohen, fcohen@starlingwatch.com
